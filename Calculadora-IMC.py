...
cal_hoje = DateEntry(frame_down, width=13, bg='darkblue', fg=cor3, borderwidth=2, date_patter= 'dd/mm/y', y=2022)
cal_hoje.place(x=180, y=30)

cal_nascimento = DateEntry(frame_down, width=13, bg='darkblue', fg=cor3, borderwidth=2, date_patter= 'dd/mm/y', y=2022)
