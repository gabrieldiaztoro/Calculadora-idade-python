...
l_data_inicial = Label(frame_baixo, text="Data de hoje", padx=0, pady=0, relief='flat', anchor=NW, font=('Ivi 11'), bg=cor1 , fg=cor3) #anchor=NM = north west
...
l_data_nascimento = Label(frame_baixo, text="Data de nascimento", width=25, height=1, padx=0, pady=0, relief='flat', anchor=NW, font=('Ivi 11 bold'), bg=cor2 , fg=cor3)
